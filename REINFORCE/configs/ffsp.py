...
runner_params = {
    ...
    'checkpoint': None,
    # 'model_path': None,
    'model_path': '../ckpt/REINFORCE/FFSP/Old-Matnet-20.pth',
...
# Matnet use the first 1000 instances for testing. We keep the same for fair comparison.
def load_data_from_Matnet_files(data_path, instance_num=1000):
